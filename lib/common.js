...
const {wepay}     = require('koa3-wechat');                         //引入微信支付 适用小程序
...
module.exports = {
  ...
  mvFile: function (file, noTimesavePath, ctx) {
    ...
    return {filePath, fileName: newFileName, fileUrl: appConfig.host + filePath}
  },
  ...
  wePay: function () {
    return new wepay({
      ...
      pfx         : fs.readFileSync(__dirname + '/../config/secret-key-file/apiclient_cert.p12'),
