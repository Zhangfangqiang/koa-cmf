...
var Wepay = function () {
  ...
  (0, _createClass3.default)(Wepay, [{
    ...
    value: function () {
      var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(order) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 5:
                ...
                params = (0, _extends3.default)({}, default_params, {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 5;
                return this.sendAndReceiveData(URLS.UNIFIED_ORDER, params, {
        ...
        return _regenerator2.default.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return this.sendAndReceiveData(URLS.ORDER_QUERY, params, {
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                _context5.next = 3;
                return this.sendAndReceiveData(URLS.REFUND, params, {
        ...
        return _regenerator2.default.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                _context6.next = 2;
                return this.sendAndReceiveData(URLS.REFUND_QUERY, params, {
        ...
        return _regenerator2.default.wrap(function _callee7$(_context7) {
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                _context7.next = 2;
                return this.sendAndReceiveData(URLS.DOWNLOAD_BILL, params, {
        ...
        return _regenerator2.default.wrap(function _callee8$(_context8) {
          while (1) {
            switch (_context8.prev = _context8.next) {
              case 0:
                _context8.next = 2;
                return this.sendAndReceiveData(URLS.SHORT_URL, params, {
                  required: ['long_url']
                });
        ...
        return _regenerator2.default.wrap(function _callee9$(_context9) {
          while (1) {
            switch (_context9.prev = _context9.next) {
              case 0:
                _context9.next = 2;
                return this.sendAndReceiveData(URLS.CLOSE_ORDER, params, {
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                _context13.next = 3;
                return this.sendAndReceiveData(URLS.TRANSFERS, params, {
                  required: requiredData,
                  useCert: true
                });
          ...
          while (1) {
            switch (_context14.prev = _context14.next) {
              case 0:
                ...
                _context14.next = 3;
                return this.sendAndReceiveData(URLS.GET_TRANSFER_INFO, params, {
                  required: requiredData,
                  useCert: true
                });
          ...
          while (1) {
            switch (_context15.prev = _context15.next) {
              ...
              case 5:
                ...
                _context15.next = 12;
                return this.sendAndReceiveData(URLS.PAY_BANK, newParams, {
                  required: requiredData,
                  useCert: true
                });
    ...
    key: 'queryBank',
    value: function () {
      var _ref18 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee17(params) {
        var requiredData;
          ...
          while (1) {
            switch (_context17.prev = _context17.next) {
              case 0:
                requiredData = ['partner_trade_no'];
                _context17.next = 3;
                return this.sendAndReceiveData(URLS.QUERY_BANK, params, {
                  required: requiredData,
                  useCert: true
                });
    ...
    value: function () {
      var _ref19 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee18(url, params, options) {
            ...
            switch (_context18.prev = _context18.next) {
              case 0:
                ...
                if (this.subAppId && this.subMchId) {
                  defaults = (0, _extends3.default)({}, defaults, {
    ...
    key: 'notifyParse',
    value: function () {
      var _ref21 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee19(xml) {
